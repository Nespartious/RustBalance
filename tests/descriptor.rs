...
#![allow(clippy::items_after_statements)] // OK in tests
#![allow(clippy::uninlined_format_args)] // OK in tests
#![allow(clippy::needless_raw_string_hashes)] // OK in tests
